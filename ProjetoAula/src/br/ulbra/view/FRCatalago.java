 ...
 * @author Sheila
 */
public class FRCatalago extends javax.swing.JFrame {

    /**
     * Creates new form FRCatalago
     */
    public FRCatalago() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FRCatalago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FRCatalago().setVisible(true);
            }
        });
    }
