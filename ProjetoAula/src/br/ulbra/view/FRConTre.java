 ...
 * @author beeme
 */
public class FRConTre extends javax.swing.JDialog {

    /**
     * Creates new form FRConUsu_
     */
    public FRConTre(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod", "NomeTre", "DescricaoTre", "DataTre", "Ativo"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FRConTre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FRConTre dialog = new FRConTre(new javax.swing.JFrame(), true);
